...
namespace JoelWarren_CE07
{
    class Utility
    {
        ...
        //// creating my own IsNullOrEmpty check for lists of objects (this needs tweaking leaving alone for now)
        //public static bool ListIsNullOrEmpty(List<object>test)
        //{
        //    // I can check for false using the null coalescing operator like
        //    // if(test?.Any() ?? false)
        //    // {return true}
        //    // else {return false}
