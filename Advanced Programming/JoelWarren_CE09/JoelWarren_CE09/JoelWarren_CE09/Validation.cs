...
namespace JoelWarren_CE09
{
    class Validation
    {
        ...
        public static string CheckForBlank(string message)
        {
            ...
            do
            {
                if (counter > 0) { Utility.ColoredConsole("Please do not leave blank!"); }
                Console.Write(message);
        ...
        // creating my own IsNullOrEmpty check for Collections
        public static bool CollectionIsNullOrEmpty<T>(ICollection<T> collection)
        {
